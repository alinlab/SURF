...
COMMON_TRAIN_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                       ...
                       ('episode_reward', 'R', 'float'), ('true_episode_reward', 'TR', 'float'),
                       ('episode_success', 'ES', 'int'),
                       ('total_feedback', 'TF', 'int'), ('labeled_feedback', 'LF', 'int'),
                       ('buffer_size', 'BS', 'int'), ('fps', 'FPS', 'float'),
                       ('total_time', 'T', 'time')]

COMMON_EVAL_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                      ('episode', 'E', 'int'), ('episode_length', 'L', 'int'),
                      ('episode_reward', 'R', 'float'), ('success_rate', 'SR', 'float'),
                      ('total_time', 'T', 'time')]
